        ...
        <Layout>
            <section className='md:h-[75vh] h-[50vh] relative'>
                ...
                <div className='w-full h-[80%] flex flex-col justify-center items-center gap-8'>
                    <h1 className='text-white md:font-bold font-extrabold md:text-5xl text-3xl text-center'>Repuestos Electricos para tu vehiculo</h1>
                    <Link to={"/productos"} className='bg-[#d82737] text-white px-4 py-2 shadow rounded-lg cursor-pointer border font-bold'>Ver Productos</Link>
                </div>
            </section>
            <section className='flex justify-center py-20'>
                <h1 className='md:text-4xl font-extrabold uppercase'>CH importadora y distribuidora.</h1>
            </section>
            <section className='bg-[#d82737] md:h-screen px-10 py-10'>
                <h2 className='md:text-4xl text-3xl text-white font-bold'>Nuestra Historia</h2>
            ...
            <section className='px-10 py-10 ' >
                <h1 className='md:text-4xl text-3xl text-[#d82737] font-bold'>Contacto y Redes</h1>
                <Box className="flex md:flex-row flex-col-reverse md:gap-0 gap-4 ">
                    <Box className="md:w-1/2 flex flex-col justify-center items-center">
                        <ul className="list-none flex flex-col gap-1 md:text-xl">
                            <li className='flex items-center gap-1'><Mail sx={{ color: "#d82737" }} /> pabloch79@hotmail.com</li>
                            <li className='flex items-center gap-1'><Phone sx={{ color: "#d82737" }} /> +54 3535 669 619</li>
                        </ul>
                    </Box>
